...
export default function Hero() {
  ...
  return (
    <section className="relative w-full max-w-7xl mx-auto px-5 md:px-6 pt-20 md:pt-24 pb-12 md:pb-16 mt-4 md:mt-8 flex flex-col gap-8 md:gap-10 overflow-hidden lg:overflow-visible">
