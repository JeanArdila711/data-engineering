        ...
        >
          ...
          <div className="relative z-10 flex items-center gap-2 lg:gap-2.5 shrink-0">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.96 }}
              className="group relative inline-flex items-center justify-center rounded-full bg-neutral-900/90 hover:bg-neutral-800 text-neutral-200 hover:text-white border border-neutral-750 hover:border-neutral-500 h-[34px] px-3.5 font-mono text-xs font-medium tracking-wide transition-all duration-200 cursor-pointer shadow-sm overflow-hidden shrink-0 whitespace-nowrap min-w-[150px] select-none"
            ...
            >
              ...
              <AnimatePresence mode="wait" initial={false}>
                {isLowerPage ? (
                  <motion.div
                    key="github-star"
                    initial={{ opacity: 0, y: 12, rotateX: -60, filter: 'blur(2px)' }}
                    animate={{ opacity: 1, y: 0, rotateX: 0, filter: 'blur(0px)' }}
                    exit={{ opacity: 0, y: -12, rotateX: 60, filter: 'blur(2px)' }}
                  ...
                  >
                    <span className="font-semibold text-white">Explorar Stack</span>
