      ...
      <header className="fixed inset-x-0 top-4 z-50 hidden md:block px-6 pointer-events-none">
        ...
        >
          ...
          <div className="relative z-10 flex items-center gap-2 lg:gap-2.5 shrink-0">
            ...
            {/* Morphing Action Button: Explorar Stack (Top) ➔ GitHub Star (Ecosistema+) */}
            <div className="relative z-10 overflow-hidden shrink-0 flex items-center justify-center min-w-[140px]">
                ...
                {isLowerPage ? (
                  ...
                  >
                    <motion.a
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="group relative inline-flex items-center justify-center gap-2 rounded-full bg-neutral-900/90 hover:bg-neutral-800 text-neutral-200 hover:text-white border border-neutral-750 hover:border-neutral-600 px-3.5 py-1.5 font-mono text-xs font-medium tracking-wide transition-all duration-200 cursor-pointer shadow-sm overflow-hidden shrink-0 whitespace-nowrap"
                    >
